...
/**
 * @file
 * Contains \Drupal\image_formatter_link_to_image_style\Plugin\Field\FieldFormatter\ImageFormatterLinkToImageStyleFormatter.
 */
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($files as $delta => $file) {
      ...
      if (!empty($this->getSetting('image_link_style'))) {
        ...
        $image_uri = $image_link_style->buildUri($file->getFileUri());
      }
      else {
