...
/**
 * @file
 * Contains \Drupal\fences\Tests\FencesDisplayTest
 */
 ...
 * @group fences
 */
class FencesDisplayTest extends WebTestBase {
...
EOD;
    ...
    $this->assertTrue(strpos($this->removeWhitspace($page), $this->removeWhitspace($expected_field_markup)) !== FALSE, 'Found the correct field markup on the page.');
  }
   ...
   */
  protected function removeWhitspace($string) {
